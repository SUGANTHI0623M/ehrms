...
import {
    ...
    UserOutlined, SendOutlined, ClockCircleOutlined, LogoutOutlined
...
const LiveRoom: React.FC = () => {
    ...
    const onLeaveModalSubmit = async (values: { feedbackSummary?: string; issues?: string }) => {
        if (!sessionId) return;
        setSubmittingLeave(true);
        try {
            await lmsService.leaveSession(sessionId, {
    ...
    return (
        <MainLayout>
            ...
            {/* Leave Room – Session Log (mandatory) and Issues/Remarks (optional) only */}
            <Modal
                title={
