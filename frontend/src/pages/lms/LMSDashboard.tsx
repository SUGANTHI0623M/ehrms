...
import { LmsStatisticCard, LmsPrimaryButton, LmsLoadingState } from '@/components/lms/SharedComponents';
import { Row, Col, Typography, List, Space, Tag, Empty, Button } from "antd";
import {
...
const LMSDashboard = () => {
    ...
    if (loading) {
        return (
            <MainLayout>
                <div className="lms-page min-h-[calc(100vh-64px)]">
            ...
            <div className="lms-page p-4 md:p-8 bg-gray-50 min-h-[calc(100vh-64px)] overflow-x-hidden">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <Space>
                            <Tag className="rounded-full">Updated: {dayjs().format('HH:mm')}</Tag>
                            <LmsPrimaryButton
                    ...
                    <Row gutter={[20, 20]}>
                        ...
                        <Col xs={24} sm={12} lg={6}>
                            <LmsStatisticCard title="Total Hours" value={data.kpi?.totalHours || 0} icon={<ClockCircleOutlined />} color="#9333ea" />
                        </Col>
                    </Row>
