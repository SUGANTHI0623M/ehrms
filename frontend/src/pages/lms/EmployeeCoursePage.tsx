...
import {
    ...
    Card, Tabs, Divider, List, Avatar, Result,
        ...
        try {
            ...
            if (error?.response?.status === 403) {
                ...
                if (code === 'COURSE_EXPIRED') {
                    message.error(msg || 'This course has expired.');
                    navigate('/lms/employee/dashboard', { state: { courseExpired: true, message: msg } });
                    return;
                }
                if (code === 'ACCESS_PAUSED') {
                    message.warning(msg || 'Your access to this course has been paused.');
                    setCourse(null);
                    setProgress(null);
                    return;
                }
