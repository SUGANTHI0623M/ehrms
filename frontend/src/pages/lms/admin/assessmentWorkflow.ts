...
export type AssessmentTabKey = (typeof ASSESSMENT_TAB_KEYS)[keyof typeof ASSESSMENT_TAB_KEYS];
    ...
    case 'Rejected':
      return {
        primary: status === 'Completed'
          ? { key: 'view_review', label: 'View Logs', primary: false, visible: true, disabled: false }
          : null,
        secondary: [],
      };
