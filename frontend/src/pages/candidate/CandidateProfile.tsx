...
const CandidateProfile = () => {
  ...
  const [uploadDocument, { isLoading: isUploading }] =
    useUploadOnboardingDocumentMutation();
  const [batchUploadDocuments, { isLoading: isBatchUploading }] =
    useBatchUploadOnboardingDocumentsMutation();
  ...
  const { data: offerData, refetch: refetchOffer } =
    useGetOfferByCandidateIdQuery(candidateId || "", {
      skip: !candidateId,
    });
  ...
  useEffect(() => {
    if (profile && profileData && !isEditingProfile) {
      const countryCode =
        profile.countryCode || profileData.countryCode || "91";
  ...
  const handleProfilePictureChange = async (
    ...
    try {
      ...
      toast.error(
        error?.data?.error?.message || "Failed to upload profile picture",
      );
                      ...
                      if (profileData.experience) {
                        setExperienceData(
                          profileData.experience.map((exp: any) => ({
                            ...
                            company: exp.company || "",
                            durationFrom: exp.durationFrom
                              ? new Date(exp.durationFrom)
                                  .toISOString()
                                  .split("T")[0]
                              : "",
                            durationTo: exp.durationTo
                              ? new Date(exp.durationTo)
                                  .toISOString()
                                  .split("T")[0]
                              : "",
                            reasonForLeaving: exp.reasonForLeaving || "",
                    ...
                    {educationData.map((edu, index) => (
                      ...
                      >
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                newEducation[index].qualification =
                                  e.target.value;
                            ...
                            <UiDatePicker
                              value={
                                edu.yearOfPassing
                                  ? (() => {
                                      const d =
                                        /^\d{4}-\d{2}-\d{2}$/.test(edu.yearOfPassing)
                                          ? parseISO(edu.yearOfPassing)
                                          : /^\d{4}$/.test(edu.yearOfPassing)
                                            ? new Date(parseInt(edu.yearOfPassing, 10), 0, 1)
                                            : null;
                              ...
                              onChange={(date) => {
                                const newEducation = [...educationData];
                                newEducation[index].yearOfPassing = date
                        ...
                        <Button
                          ...
                          onClick={() => {
                            setEducationData(
                              educationData.filter((_, i) => i !== index),
                            );
                          }}
                        >
                          <X className="w-4 h-4 mr-2" />
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                                <span>
                                  {edu.yearOfPassing
                                    ? /^\d{4}-\d{2}-\d{2}$/.test(edu.yearOfPassing)
                                      ? format(parseISO(edu.yearOfPassing), "yyyy")
                                      : edu.yearOfPassing
                                    : ""}
                                </span>
                    ...
                    {experienceData.map((exp, index) => (
                      ...
                      >
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                newExperience[index].designation =
                                  e.target.value;
                            ...
                            <UiDatePicker
                              value={
                                exp.durationFrom
                                  ? (() => {
                                      const d =
                                        /^\d{4}-\d{2}-\d{2}$/.test(exp.durationFrom)
                                          ? parseISO(exp.durationFrom)
                                          : /^\d{4}$/.test(exp.durationFrom)
                                            ? new Date(parseInt(exp.durationFrom, 10), 0, 1)
                                            : null;
                                      return d && isValid(d) ? d : undefined;
                                    })()
                                  : undefined
                            ...
                            <UiDatePicker
                              value={
                                exp.durationTo
                                  ? (() => {
                                      const d =
                                        /^\d{4}-\d{2}-\d{2}$/.test(exp.durationTo)
                                          ? parseISO(exp.durationTo)
                                          : /^\d{4}$/.test(exp.durationTo)
                                            ? new Date(parseInt(exp.durationTo, 10), 0, 1)
                                            : null;
                                      return d && isValid(d) ? d : undefined;
                                    })()
                                  : undefined
                          ...
                          <div className="col-span-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => {
                                const newExperience = [...experienceData];
                                newExperience[index].keyResponsibilities =
                                  e.target.value;
                                setExperienceData(newExperience);
                              }}
                          ...
                          <div className="col-span-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                const newExperience = [...experienceData];
                                newExperience[index].reasonForLeaving =
                                  e.target.value;
                                setExperienceData(newExperience);
                              }}
                        ...
                        <Button
                          ...
                          onClick={() => {
                            setExperienceData(
                              experienceData.filter((_, i) => i !== index),
                            );
                          }}
                        >
                          <X className="w-4 h-4 mr-2" />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {selectedResumeFile && (
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {((resumePreview?.size || 0) / 1024 / 1024).toFixed(
                              2,
                            )}{" "}
                            MB
                          </p>
                  ...
                  <div className="space-y-2">
                    ...
                    {offer.salary && (
                      <p className="text-sm text-muted-foreground">
                        ...
                        {typeof offer.salary.amount === "number"
                          ? offer.salary.amount.toLocaleString()
                          : offer.salary.amount || ""}{" "}
                ...
                {offer.status === "SENT" && (
                  <div className="pt-2 border-t space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Button
                        onClick={() =>
                          navigate(`/candidate/offer/${offer._id}`)
                        }
                        variant="outline"
                        size="sm"
                        className="flex-1"
        ...
        >
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                View and upload required documents for onboarding by job
                position
              </DialogDescription>
            </DialogHeader>
            ...
            {allOnboardings.length > 0 ? (
              <div className="space-y-6 py-4">
                {allOnboardings.map((onboardingItem: any) => {
                  ...
                  const jobIdValue =
                    candidateIdData && typeof candidateIdData === "object"
                  ...
                  const jobTitle =
                    jobData?.title ||
                    (candidateIdData && typeof candidateIdData === "object"
                      ? (candidateIdData as any)?.position
                      : null) ||
                    "Unknown Position";
                  const jobDepartment =
                    jobData?.department ||
                    onboardingItem.staffId?.department ||
                    "-";
                    ...
                    >
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-3 italic">
                          The documents below are required for this job
                          position.
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
                        <div>
                          ...
                          <p className="font-medium">
                            {onboardingItem.staffId?.employeeId || "Pending"}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {onboardingItem.staffId?.designation ||
                              (candidateIdData &&
                              typeof candidateIdData === "object"
                                ? (candidateIdData as any)?.position
                                : null) ||
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {onboardingItem.staffId?.joiningDate
                              ? format(
                                  new Date(onboardingItem.staffId.joiningDate),
                                  "yyyy-MM-dd",
                                )
                              : "-"}
                          </p>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-bold">
                            {onboardingItem.progress}%
                          </span>
                        </div>
                        <Progress
                          value={onboardingItem.progress}
                          className="h-3"
                        />
                      </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-semibold">
                              Required Documents for {jobTitle}
                            </p>
                            {(() => {
                              const requiredDocs =
                                onboardingItem.documents.filter(
                                  (doc) =>
                                    doc.required &&
                          ...
                          {Object.keys(pendingUploads).filter((key) =>
                            key.startsWith(`${onboardingItem._id}_`),
                          ).length > 0 && (
                            <Button
                              onClick={async () => {
                                ...
                                try {
                                  ...
                                  const documentIds = Object.keys(
                                    ...
                                    .map((key) =>
                                      key.replace(`${onboardingItem._id}_`, ""),
                                    );
                                  const files = documentIds.map(
                                    (id) =>
                                      pendingUploads[
                                        `${onboardingItem._id}_${id}`
                                      ],
                                  );
              ...
              <div className="space-y-6 py-4">
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <p className="font-medium text-blue-900 dark:text-blue-100">
                              {jobData?.title ||
                                onboarding.candidateId?.position ||
                                "-"}
                            </p>
                          </div>
                          <div>
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
                  <div>
                    ...
                    <p className="font-medium">
                      {onboarding.staffId?.employeeId || "Pending"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {onboarding.staffId?.designation ||
                        onboarding.candidateId?.position ||
                        "-"}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium">
                      {onboarding.staffId?.joiningDate
                        ? format(
                            new Date(onboarding.staffId.joiningDate),
                            "yyyy-MM-dd",
                          )
                        : "-"}
                    </p>
                      ...
                      {onboarding &&
                        (() => {
                          ...
                          if (missingRequired.length > 0) {
                            return (
                              <p className="text-xs text-red-500 mt-1">
                                {missingRequired.length} required document(s)
                                missing
                              </p>
                            );
                          }
                        ...
                        <div className="flex-1">
                          ...
                          {pendingUploads[doc._id] && (
                            <span className="text-xs text-blue-600 flex items-center gap-1 mt-1">
                              <Clock className="w-3 h-3" />
                              Pending:{" "}
                              {(pendingUploads[doc._id].size / 1024).toFixed(
                                2,
                              )}{" "}
                              KB
                            </span>
        ...
        <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to reject this offer? This action cannot
                be undone.
              </DialogDescription>
            </DialogHeader>
