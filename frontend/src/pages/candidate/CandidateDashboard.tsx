                ...
                {onboarding.staffId ? (
                  <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
                    <div>
                      ...
                      <p className="font-medium">{onboarding.staffId.employeeId || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground">Department</p>
                      <p className="font-medium">{onboarding.staffId.department || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground">Designation</p>
                      <p className="font-medium">{onboarding.staffId.designation || "N/A"}</p>
                    </div>
                    <div>
