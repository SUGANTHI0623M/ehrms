...
import { Star, Calendar, FileText, ArrowLeft, User, Award, Clock, AlertCircle } from "lucide-react";
import { Skeleton } from "@/components/ui/skeleton";

const EmployeePerformanceReviewDetail = () => {
      ...
      <main className="p-3 sm:p-6">
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" onClick={() => navigate("/employee/performance/reviews")}>
...
export default EmployeePerformanceReviewDetail;
