...
const EmployeeSalaryOverview = () => {
  ...
  // For current month, use current date instead of end of month
  ...
  // Fetch attendance for the selected month - only till current date for current month
  ...
  // Calculate present days including half-days (0.5 each)
  ...
  if (staffSalary && 'basicSalary' in staffSalary && typeof staffSalary.basicSalary === 'number' && staffSalary.basicSalary > 0) {
    ...
    if (proratedSalary && calculatedSalary) {
      ...
      console.log('[EmployeeSalaryOverview] Salary Calculation:', {
        ...
        finalNetAfterFines: (proratedSalary.proratedNetSalary - fineInfo.totalFineAmount).toFixed(2),
