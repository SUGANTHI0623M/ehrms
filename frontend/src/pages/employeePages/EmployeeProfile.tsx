...
const EmployeeProfile = () => {
  ...
  const [updateEmployeeProfile, { isLoading: isUpdating }] =
    useUpdateEmployeeProfileMutation();
  ...
  const candidateData =
    staffData?.candidateId && typeof staffData.candidateId === "object"
      ? staffData.candidateId
      : null;
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2 justify-center sm:justify-start">
                  ...
                  <Badge
                    variant={
                      staffData.status === "Active" ? "default" : "secondary"
                    }
                  >
                    {staffData.status}
                  </Badge>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.dob
                      ? format(new Date(staffData.dob), "MMMM dd, yyyy")
                      : "N/A"}
                  </p>
                )}
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {staffData.salary && (
                <>
                  {staffData.salary.gross !== undefined &&
                    staffData.salary.gross !== null && (
                      <div>
                        <Label>Gross Salary</Label>
                        <p className="font-medium mt-2">
                          {formatINR(Number(staffData.salary.gross))}
                        </p>
                      </div>
                    )}
                  {staffData.salary.net !== undefined &&
                    staffData.salary.net !== null && (
                      <div>
                        <Label>Net Salary</Label>
                        <p className="font-medium mt-2">
                          {formatINR(Number(staffData.salary.net))}
                        </p>
                      </div>
                    )}
                </>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.address?.postalCode || "N/A"}
                  </p>
                )}
              </div>
              <div>
              ...
              <div>
                ...
                {isEditing && !isEmployee ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("pfNumber", e.target.value)
                    }
                    className="mt-2"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.bankDetails?.bankName || "N/A"}
                  </p>
                )}
              </div>
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.bankDetails?.accountNumber || "N/A"}
                  </p>
                )}
              </div>
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.bankDetails?.ifscCode || "N/A"}
                  </p>
                )}
              </div>
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.bankDetails?.accountHolderName || "N/A"}
                  </p>
                )}
              </div>
              <div>
                ...
                {isEditing && !isEmployee ? (
                  ...
                  <p className="font-medium mt-2">
                    {staffData.bankDetails?.upiId || "N/A"}
                  </p>
                )}
              </div>
            </div>
          ...
          <CardHeader>
            ...
            {onboarding && (
              <p className="text-sm text-muted-foreground mt-1">
                Progress: {onboarding.progress}% • Status:{" "}
