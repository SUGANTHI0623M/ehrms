...
const SuperAdminSettings = () => {
  ...
  useEffect(() => {
    if (settings) {
      ...
      setSecuritySettings({
        passwordPolicy:
          settings.security?.passwordPolicy || securitySettings.passwordPolicy,
        sessionTimeout: settings.security?.sessionTimeout || 480,
        loginRateLimit:
          settings.security?.loginRateLimit || securitySettings.loginRateLimit,
        apiRateLimit:
          settings.security?.apiRateLimit || securitySettings.apiRateLimit,
      });
      setBillingSettings({
            ...
            <TabsContent value="subscriptions">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create, edit, and manage subscription plans (Standard,
                    Medium, Enterprise)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Manage subscription plans with configurable features,
                      limits, and pricing. Assign plans to companies and control
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                                ...
                                onClick={() => {
                                  ...
                                  setLogoPreview(
                                    settings?.general?.platformLogo
                                      ? settings.general.platformLogo.startsWith(
                                          "http",
                                        ) ||
                                        settings.general.platformLogo.startsWith(
                                          "/",
                          ...
                          <p className="text-xs text-muted-foreground">
                            Upload a platform logo (JPG, PNG, or SVG, max 5MB).
                            This will be displayed on login and register pages.
                          </p>
                        </div>
                      </div>
                      <Button
            ...
            <TabsContent value="security">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure password policies, session timeouts, and rate
                    limits
                  </CardDescription>
                </CardHeader>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                ...
                                type="number"
                                value={
                                  securitySettings.loginRateLimit.maxAttempts
                                }
                                onChange={(e) =>
                                  setSecuritySettings({
                                    ...securitySettings,
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                type="number"
                                value={
                                  securitySettings.loginRateLimit.windowMinutes
                                }
                                onChange={(e) =>
                                  setSecuritySettings({
                                    ...securitySettings,
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                ...
                                type="number"
                                value={
                                  securitySettings.apiRateLimit.maxRequests
                                }
                                onChange={(e) =>
                                  setSecuritySettings({
                                    ...securitySettings,
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                type="number"
                                value={
                                  securitySettings.apiRateLimit.windowMinutes
                                }
                                onChange={(e) =>
                                  setSecuritySettings({
                                    ...securitySettings,
