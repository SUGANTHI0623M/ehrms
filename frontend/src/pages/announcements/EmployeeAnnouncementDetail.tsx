...
const EmployeeAnnouncementDetail = () => {
  ...
  const { data, isLoading } = useGetEmployeeAnnouncementByIdQuery(id!, { skip: !id });
  ...
  return (
    <MainLayout>
      ...
      >
        {/* Top bar: Back only (no Edit for employee) */}
        <div
        ...
        {/* Subsections: alternating two-column layout (same as admin) */}
