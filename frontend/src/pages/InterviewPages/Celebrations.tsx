...
/**
 * Celebration module – under Interview.
 * Manages birthday wishes, work anniversary wishes, and all celebration-related content and templates.
 */
    ...
    <main className="p-4 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl md:text-2xl font-bold">Celebration</h2>
        </div>
      ...
      <Tabs value={tab} onValueChange={setTab} className="flex flex-col md:flex-row gap-6 my-3">
        ...
        <div className="flex-1">
          <TabsContent value="birthdays" className="space-y-2">
            <h3 className="font-semibold text-lg mb-4">Birthday wishes</h3>
          ...
          <TabsContent value="anniversaries" className="space-y-2">
            <h3 className="font-semibold text-lg mb-4">Work anniversary wishes</h3>
