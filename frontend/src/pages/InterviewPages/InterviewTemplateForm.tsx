        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 space-y-4">
            ...
            {questionType === "scenario" && (
              <div className="space-y-2">
                <Label>Scenario details (optional)</Label>
                <Textarea
                  {...register(`${questionPath}.evaluationCriteria`)}
                  placeholder="Describe the scenario that the candidate will respond to (e.g. situation, context, or prompt). This will be shown during the interview."
                  rows={4}
                />
                <p className="text-xs text-muted-foreground">
                  This text will be displayed during the interview so the candidate can answer based on the scenario.
                </p>
              </div>
            )}
          </div>
