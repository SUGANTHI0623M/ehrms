...
import { Search, ChevronRight, Clock, Users, Calendar, Briefcase, DollarSign, Building, Settings as SettingsIcon, LogOut, FilePlus, MapPin, Shield } from "lucide-react";
...
const Settings = () => {
  ...
  const settingsGroups = [
    ...
    },
    {
      ...
      icon: Shield,
      items: [
        { name: "Two-Factor Authentication", description: "Enable/Disable 2FA for staff members", path: "/attendance-setting" }
      ]
    },
    {
      title: "Others",
                      ...
                      {group.items.map((item, itemIndex) => (
                        <div
                          ...
                          onClick={() => {
                            ...
                            } else if (item.name === "Two-Factor Authentication") {
