  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (responses.length === 0) {
        const staffName =
          staffList.find((s: any) => s._id === selectedStaff)?.name ||
          "selected staff";
      ...
      const rows = responses.map((response: any) => {
        const staffName =
          typeof response.staffId === "object"
            ? response.staffId.name
            : "Unknown";
        const taskId =
          typeof response.taskId === "object"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Form Details Report - Shows details of forms filled by
                      employees during task completion
                    </p>
                  </div>
                </div>
              </CardHeader>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        See the details of forms filled by employees while
                        completing tasks
                      </p>
                    </div>
                  </div>
