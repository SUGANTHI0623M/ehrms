...
const FormTemplates = () => {
  ...
  const getActiveTab = () => {
    ...
    // Default to templates if path doesn't match any specific tab
    return "templates";
  };
  ...
  const handleFieldChange = (
    index: number,
    updates: Partial<FormTemplateField>,
  ) => {
  ...
  const handleSaveAssignedStaff = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          error?.data?.error?.message || "Failed to update staff assignment",
        variant: "destructive",
      });
    }
  };
                        ...
                        {templates.map((template) => {
                          const createdBy =
                            typeof template.createdBy === "object"
                              ...
                              : "Unknown";
                          const createdOn = template.createdAt
                            ? format(
                            ...
                            : "-";
                          const deactivatedAt =
                            template.deactivatedAt && !template.isActive
                              ? format(
                                  new Date(template.deactivatedAt),
                                  "dd MMM yyyy",
                                )
                              : null;
                          ...
                          const assignedToCount =
                            template.assignedToCount ||
                            (Array.isArray(template.assignedTo)
                              ...
                              <td className="p-3">
                                ...
                                <div className="mt-2">
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleOpenAssignModal(template)
                                    }
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: FormTemplateField["type"]) => {
                          const updates: Partial<FormTemplateField> = {
                            type: value,
                          };
                          if (value !== "Image") {
                            ...
                            {field.options?.map((option, optIndex) => (
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleRemoveDropdownOption(index, optIndex)
                                  }
                                >
                                  <X className="w-3 h-3" />
                                </Button>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              template and it will no longer be available for tasks.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
