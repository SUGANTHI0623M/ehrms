              ...
              <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Manage custom fields to capture additional details
                            on tasks
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors cursor-pointer group">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold">
                            Staff who can schedule tasks
                          </h3>
                          <p className="text-sm text-muted-foreground mt-1">
                            Select staff who will be able to schedule tasks
                          </p>
                        </div>
                      </div>
                      <ChevronRight className="w-5 h-5 text-muted-foreground group-hover:text-foreground transition-colors" />
                ...
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        When enabled, tasks assigned by admin will be
                        auto-approved without employee acceptance
                      </p>
                    </div>
                    <Switch
                      checked={autoApprove}
                ...
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-semibold">
                        Require Approval on Completed Tasks
                      </h3>
                      <p className="text-sm text-muted-foreground mt-1">
                        When enabled, completed tasks require admin approval.
                        When disabled, task status updates automatically from
                        employee side
                      </p>
                    </div>
                    <Switch
                ...
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Mandatorily require your staff to complete tasks by
                        filling in a customer-sent OTP
                      </p>
                    </div>
                    <Switch
                      checked={otpVerification}
                      onCheckedChange={handleOtpVerificationChange}
                      disabled={isLoading}
                    />
                  </div>
                </div>
