...
import { Search, Filter, Users, MapPin, Settings, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="ml-64 mt-16 p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground">HRMS Geo Settings</h1>
            <p className="text-muted-foreground mt-1">Configure HRMS Geo system settings and staff location access</p>
          </div>
