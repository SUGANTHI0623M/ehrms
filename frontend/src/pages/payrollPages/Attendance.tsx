...
const Attendance = () => {
  ...
  const statsArray = [
    ...
    {
      title: "Half Day",
      value: stats?.halfDay?.toString() || "0",
      icon: Clock,
      color: "text-warning",
    },
    {
      title: "Not Marked",
      value: stats?.notMarked?.toString() || "0",
      icon: AlertCircle,
      color: "text-muted-foreground",
    },
    {
      title: "Punched In",
      value: stats?.punchedIn?.toString() || "0",
      icon: Users,
      color: "text-primary",
    },
    {
      title: "Punched Out",
      value: stats?.punchedOut?.toString() || "0",
      icon: Users,
      color: "text-muted-foreground",
    },
  ];
      ...
      <main className="p-3 sm:p-6">
        <div className="mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { label: "On Leave", data: leaveStats },
              { label: "Overtimes & Fines", data: overtimeStats },
              { label: "Other", data: otherStats },
            ].map((sec, i) => (
              <Card key={i}>
                <CardHeader>
