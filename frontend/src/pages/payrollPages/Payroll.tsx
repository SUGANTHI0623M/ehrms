        ...
        <div className="mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <Card>
              ...
              <CardContent>
                <div className="text-xl sm:text-2xl font-bold">
                  {isLoadingStats ? "Loading..." : (stats ? formatINR(stats.totalPayroll) : "—")}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-xl sm:text-2xl font-bold">
                  {isLoadingStats ? "Loading..." : (stats ? formatINR(stats.totalDeductions) : "—")}
                </div>
                      ...
                      {selectedPayroll.components?.map((comp: any, idx: number) => (
                        <div key={idx} className="flex items-center justify-between p-2 border rounded">
                          ...
                          <div className="text-right">
                            <div className="font-semibold">{formatINR(comp.amount)}</div>
                          </div>
                        </div>
                      ))}
                    </div>
