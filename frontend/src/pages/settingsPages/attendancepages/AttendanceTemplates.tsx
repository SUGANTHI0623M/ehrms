                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      <span
                        className="font-semibold cursor-pointer underline hover:text-primary"
                        onClick={() => navigate(`/attendance-templates/${template._id}/staff`)}
                      >
                        Assigned Staff: {template.assignedStaffCount || 0} Staffs
                      </span>
                    </p>
